...
<body>
	...
	<div class="right_cont">
		...
		<div class="bj">
			<form
				action="${pageContext.request.contextPath}/theoreticalPlan_goupdateExpdepartment.action?newcurrentpage=${newcurrentpage }&newdepartmenttag1=${newdepartmenttag1 }"
				method="post">
				<div>
					<h5>&nbsp;&nbsp;&nbsp;&nbsp;中文名称：${Curriculum.curriculumCname }
						...
						<h5>
							&nbsp;&nbsp;&nbsp;&nbsp;开课实验室： <select size="1"
								...
								<c:forEach items="${experimentslist }" var="experiment">
									<option value="${experiment.experimentid }">${experiment.experimentname }</option>
								</c:forEach>
								<lect>
						</h5>
					</tr>
