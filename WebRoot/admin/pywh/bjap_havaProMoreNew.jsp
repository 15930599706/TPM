...
<body>
	<div class="right_cont">
		...
		<div class="link">
			<c:if test="${user.adminlevel == 1 }">
				<a
					href="${pageContext.request.contextPath}/mainTainOfPT_tobjapPage.action?departmentid=${user.department.departmentid}">返回</a>
			</c:if>
			<c:if test="${user.adminlevel == 5 }">
				<a
					href="${pageContext.request.contextPath}/mainTainOfPT_topyapPage.action?tnum=${user.tnum }&collegeid=-1">返回</a>
			</c:if>
		</div>
	...
	<div id="detail2">
		...
		<div id="box9">
			...
			<form
				action="${pageContext.request.contextPath}/mainTainOfPT_delTrainingEventsNew.action"
				method="post">
				<c:forEach items="${professionalList}" var="professional">
					<input type="hidden" name="professionalList"
						value="${professional.professionalid }">
	...
	<div id="detail">
		...
		<div id="box4">
			...
			<form
				action="${pageContext.request.contextPath}/mainTainOfPT_addTrainingEventsNew.action"
				method="post">
				<c:forEach items="${professionalList}" var="professional">
					<input type="hidden" name="professionalList"
						value="${professional.professionalid }">
