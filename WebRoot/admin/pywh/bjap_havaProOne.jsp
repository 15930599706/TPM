...
<script language="javascript">	
		function save(){	
			...
			form.action="${pageContext.request.contextPath}/mainTainOfPT_updatemainTainOfPT1.action?departmentid=${department.departmentid}";
			form.submit();  
		}
...
<body>
	<div class="right_cont">
		...
		<c:if
			...
			<div id="box1">
				<c:if test="${user.adminlevel == 1}">
					<a
						onclick="if (confirm('修改填写方式后，所填写的总体安排表将一并清空！')) return true; else return false;"
						href="mainTainOfPT_changetag.action?departmentid=${department.departmentid }">改为分专业方向填写总体安排表</a>
				</c:if>

				<c:if test="${user.adminlevel == 5}">
					<a
						onclick="if (confirm('修改填写方式后，所填写的总体安排表将一并清空！')) return true; else return false;"
						href="mainTainOfPT_revisechangetag.action?departmentid=${department.departmentid }">改为分专业方向填写总体安排表</a>
				</c:if>
			</div>
		</c:if>
		<div id="box00">
		...
		<div id="box2">
			...
			<form id="ap" method='post'
				action='${pageContext.request.contextPath}/mainTainOfPT_updatemainTainOfPT.action?departmentid=${department.departmentid}'>
					...
					<c:forEach items="${mainTainOfPTlist }" var="mainTainOfPT"
						...
						<tr>
							...
							<th><select style="width: 40px;" name="week1">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week1 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
							...
							<th><select style="width: 40px;" name="week2">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week2 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
							...
							<th><select style="width: 40px;" name="week3">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week3 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
							...
							<th><select style="width: 40px;" name="week4">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week4 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
							...
							<th><select style="width: 40px;" name="week5">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week5 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
							...
							<th><select style="width: 40px;" name="week6">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week6 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
							...
							<th><select style="width: 40px;" name="week7">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week7 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
									<option></option>
							</select></th>
							<th><select style="width: 40px;" name="week8">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week8 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
									<option></option>
							</select></th>
							<th><select style="width: 40px;" name="week9">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week9 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
									<option></option>
							</select></th>
							<th><select style="width: 40px;" name="week10">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week10 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
									<option></option>
							</select></th>
							<th><select style="width: 40px;" name="week11">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week11}">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
									<option></option>
							</select></th>
							<th><select style="width: 40px;" name="week12">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week12 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
									<option></option>
							</select></th>
							<th><select style="width: 40px;" name="week13">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week13 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
									<option></option>
							</select></th>
							<th><select style="width: 40px;" name="week14">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week14 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
									<option></option>
							</select></th>
							<th><select style="width: 40px;" name="week15">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week15 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
									<option></option>
							</select></th>
							<th><select style="width: 40px;" name="week16">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week16 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
									<option></option>
							</select></th>
							<th><select style="width: 40px;" name="week17">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week17 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
									<option></option>
							</select></th>
							<th><select style="width: 40px;" name="week18">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week18 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
									<option></option>
							</select></th>
							<th><select style="width: 40px;" name="week19">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week19 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
									<option></option>
							</select></th>
							<th><select style="width: 40px;" name="week20">
									...
									<c:forEach items="${trainingEventslist }" var="trainingEvents">
										<option value="${trainingEvents.trainingEventscode }"
											<c:if test="${trainingEvents.trainingEventscode eq mainTainOfPT.week20 }">selected="selected"</c:if>>${trainingEvents.trainingEventscode }</option>
									</c:forEach>
									<option></option>
							</select></th>
	...
	<div id="detail2">
		...
		<div id="box9">
			...
			<form
				action="${pageContext.request.contextPath}/mainTainOfPT_delTrainingEvents.action"
				method="post">
				<div>
					事件名称：<select name="trainingEventsid">
						<c:forEach items="${trainingEventslist }" var="trainingEvents">
							<option value="${trainingEvents.trainingEventsid }">${trainingEvents.trainingEventsname }</option>
						</c:forEach>
					</select>
				</div>
	...
	<div id="detail">
		...
		<div id="box4">
			...
			<form
				action="${pageContext.request.contextPath}/mainTainOfPT_addTrainingEvents.action"
				method="post">
				<div>
