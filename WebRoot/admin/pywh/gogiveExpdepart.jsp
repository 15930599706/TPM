...
<body>
	...
	<div class="right_cont">
		...
		<div class="bj">
			<form
				action="${pageContext.request.contextPath}/theoreticalPlan_goupdateExpdepart.action?newcurrentpage=${newcurrentpage }&newdepartmenttag1=${newdepartmenttag1 }"
				method="post">
				<div>
				...
				<div>
					<tr>
						<h5>
							&nbsp;&nbsp;&nbsp;&nbsp;开课专业： <select size="1"
								name="cteachDepartment.departmentid">
