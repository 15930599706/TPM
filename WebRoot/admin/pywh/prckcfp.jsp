		...
		function selectSubmit()	//表单提交
			{
					...
					form.action="${pageContext.request.contextPath}/practicePlan_prctokcfpPage.action";
					form.submit();   
			}
	</script>
<body>
	<div class="right_cont">
		<div class="title_right">
			<strong>实践课程分配信息</strong>
		</div>
		<div id="box2">
			<form
				action="${pageContext.request.contextPath}/practicePlan_prctokcfpPage.action"
		...
		<div style="width: 90%; margin-left: 24px;">
			...
			<table class="table table-bordered table-striped table-hover">
							...
							<form method="post" id="like${xh.count}"
								...
								<select name="depart" size="1">
									<c:forEach items="${pageBean.practiceLessonlist[xh.count-1]}"
										...
										<c:if test="${theoreticalLesson.practiceLessonid ne null}">
										...
										<c:if test="${theoreticalLesson.practiceLessonid eq null}">
				...
				<form method="post" name="form11"
					action="${pageContext.request.contextPath}/practicePlan_prctokcfpPage.action?curriculum.college.collegeid=
					...
					<tfoot>
						<tr align="center">
							<th nowrap="nowrap" colspan="11"><c:if
									...
									<a
										href="${pageContext.request.contextPath}/practicePlan_prctokcfpPage.action?curriculum.college.collegeid=${cid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}"><small>首页</small></a>&nbsp;&nbsp;&nbsp;
										<a
										href="${pageContext.request.contextPath}/practicePlan_prctokcfpPage.action?currentpage=${currentpage-1 }&curriculum.college.collegeid=${cid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}"><small>上一页</small></a>
								</c:if>&nbsp;&nbsp;&nbsp; <small>共${pageBean.totalCount }条记录,共计${pageBean.totalPage }页,当前第${pageBean.currentpage }页</small>&nbsp;&nbsp;&nbsp;
								<c:if test="${pageBean.currentpage != pageBean.totalPage }">
									<a
										href="${pageContext.request.contextPath}/practicePlan_prctokcfpPage.action?currentpage=${currentpage+1 }&curriculum.college.collegeid=${cid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}"><small>下一页</small></a>&nbsp;&nbsp;&nbsp;
										<a
										href="${pageContext.request.contextPath}/practicePlan_prctokcfpPage.action?currentpage=${pageBean.totalPage }&curriculum.college.collegeid=${cid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}"><small>尾页</small></a>
