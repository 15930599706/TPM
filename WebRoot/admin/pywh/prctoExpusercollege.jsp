...
<body>
	<div class="right_cont">
		...
		<div id="box2">
			<form
				action="${pageContext.request.contextPath}/practicePlan_prctoExpusercollege.action?tnum=${user.tnum }"
	...
	<div style="width: 90%; margin-left: 95px;">
		...
		<table class="table table-bordered table-striped table-hover">
			...
			<c:forEach items="${pageBean.curriculumlist }" var="curriculum"
				...
				<tr align="center">
					...
					<td nowrap="nowrap"><small> <c:forEach
								...
								<c:if
									test="${theoreticalLesson.teachDepartment.departmentCname eq null and theoreticalLesson.teacher.username eq null and theoreticalLesson.experiment.experimentname eq null and theoreticalLesson.experimenter.username eq null}">
									<span style="color: red;"> 未分配</span>
								</c:if>
								<c:if
									test="${theoreticalLesson.teachDepartment.departmentCname ne null or theoreticalLesson.teacher.username ne null or theoreticalLesson.experiment.experimentname ne null or theoreticalLesson.experimenter.username ne null}">
			...
			<form method="post" name="form11"
				action="${pageContext.request.contextPath}/practicePlan_prctoExpusercollege.action?tnum=${user.tnum }&curriculum.college.collegeid=
				...
				<tfoot>
					<tr align="center">
						<th nowrap="nowrap" colspan="11"><c:if
								...
								<a
									href="${pageContext.request.contextPath}/practicePlan_prctoExpusercollege.action?tnum=${user.tnum }&curriculum.college.collegeid=${user.college.collegeid}&curriculum.curriculumid=${practiceLesson.curriculum.curriculumid}&curriculum.curriculumCname=${practiceLesson.curriculum.curriculumCname}&departmenttag=0"><small>首页</small></a>&nbsp;&nbsp;&nbsp;
										<a
									href="${pageContext.request.contextPath}/practicePlan_prctoExpusercollege.action?tnum=${user.tnum }&currentpage=${currentpage-1 }&curriculum.college.collegeid=${user.college.collegeid}&curriculum.curriculumid=${practiceLesson.curriculum.curriculumid}&curriculum.curriculumCname=${practiceLesson.curriculum.curriculumCname}&departmenttag=${newdepartmenttag}"><small>上一页</small></a>
	...
	<script language="javascript">
		...
		{	
			...
			/* alert(form); */
			form.action="${pageContext.request.contextPath}/practicePlan_proexpkctousercollege.action?experimenter.tnum&experimenter.username&departmenttag&newcurrentpage=${currentpage}";
			form.submit();  
		}
</script>
