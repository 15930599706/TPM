...
<body>
	<div class="right_cont">
		...
		<div id="box2">
			<form
				action="${pageContext.request.contextPath}/practicePlan_prctodepartment.action"
		...
		<div style="width: 1000px;">
			<div id="box0">
				<button class="btn btn-info  ">
					<a
						href="${pageContext.request.contextPath}/practicePlan_A_key_distribution.action?curriculum.college.collegeid=${user.college.collegeid}&curriculum.curriculumid=${practiceLesson.curriculum.curriculumid}&curriculum.curriculumCname=${practiceLesson.curriculum.curriculumCname}&departmenttag=0">一键分配</a>
				</button>
			</div>
			<div id="box00">
		...
		<div style="width: 90%; margin-left: 24px; margin-top: 70px;">
			...
			<table class="table table-bordered table-striped table-hover">
				...
				<c:forEach items="${pageBean.curriculumlist }" var="curriculum"
					...
					<tr align="center">
						...
						<td nowrap="nowrap"><small> <c:forEach
									...
									<c:if
										test="${practiceLesson.teachDepartment.departmentCname ne null or practiceLesson.teacher.username ne null or practiceLesson.experiment.experimentname ne null or practiceLesson.experimenter.username ne null}">
										<span style="color: green;"> 已分配 <%-- (<c:if test="${practiceLesson.teachDepartment.departmentCname ne null}"><span>专业</span></c:if><c:if test="${practiceLesson.teachDepartment.departmentCname eq null and practiceLesson.teacher.username ne null}"><span>教师</span></c:if>)</span> --%>
									</c:if>
						...
						<td nowrap="nowrap"><small> <c:forEach
									...
									var="practiceLesson" end="0">
									<c:if
										test="${practiceLesson.teachDepartment.departmentCname eq null}">
										<a href="javascript:void(0)"
											onclick="selectonSubmit('${xh.count}')">分配开课专业</a>
									</c:if>
									<c:if
										test="${practiceLesson.teachDepartment.departmentCname ne null}">
										<a href="javascript:void(0)"
				...
				<form method="post" name="form11"
					action="${pageContext.request.contextPath}/practicePlan_prctodepartment.action?curriculum.college.collegeid=
					...
					<tfoot>
						<tr align="center">
							<th nowrap="nowrap" colspan="11"><c:if
									...
									<a
										href="${pageContext.request.contextPath}/practicePlan_prctodepartment.action?curriculum.college.collegeid=${user.college.collegeid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}&departmenttag=0"><small>首页</small></a>&nbsp;&nbsp;&nbsp;
										<a
										href="${pageContext.request.contextPath}/practicePlan_prctodepartment.action?currentpage=${currentpage-1 }&curriculum.college.collegeid=${user.college.collegeid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}&departmenttag=${newdepartmenttag}"><small>上一页</small></a>
								...
								<c:if test="${pageBean.currentpage != pageBean.totalPage }">
									<a
										...
										<a
										href="${pageContext.request.contextPath}/practicePlan_prctodepartment.action?currentpage=${pageBean.totalPage }&curriculum.college.collegeid=${user.college.collegeid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}&departmenttag=${newdepartmenttag}"><small>尾页</small></a>
		...
		{	
			...
			form.action="${pageContext.request.contextPath}/practicePlan_gogivedepartment.action?departmenttag&newcurrentpage=${currentpage}";
			form.submit();  
		}
		</script>
