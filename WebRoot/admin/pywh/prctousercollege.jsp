...
<body>
	<div class="right_cont">
		...
		{	
			...
			form.action="${pageContext.request.contextPath}/practicePlan_kctousercollege.action?teacher.tnum&teacher.username&departmenttag&newcurrentpage=${currentpage}";
			form.submit();  
		}
</script>
