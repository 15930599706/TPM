...
<body>
	<div class="right_cont">
		...
		<div id="box2">
			<form
				action="${pageContext.request.contextPath}/practicePlan_prctousercollege.action?tnum=${user.tnum }"
		...
		<div style="width: 90%; margin-left: 24px;">
			...
			<table class="table table-bordered table-striped table-hover">
									...
									<c:forEach items="${pageBean.practiceLessonlist[xh.count-1]}"
										...
										<label> <c:if
												...
												<span style="color: green;"> <c:if
														...
														<option
															value="${theoreticalLesson.professional.professionalid}">${theoreticalLesson.department.departmentCname}（${theoreticalLesson.professional.professionalname}）——${theoreticalLesson.teacher.username }</span>
												</option>
											</c:if> <c:if
				...
				<form method="post" name="form11"
					action="${pageContext.request.contextPath}/practicePlan_prctousercollege.action?tnum=${user.tnum }&curriculum.college.collegeid=
		...
		{	
			...
			form.action="${pageContext.request.contextPath}/practicePlan_kctousercollege.action?teacher.tnum&teacher.username";
			form.submit();  
		}
</script>
