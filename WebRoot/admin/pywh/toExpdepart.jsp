...
<body>
	<div class="right_cont">
		...
		<div id="box2">
			<form
				action="${pageContext.request.contextPath}/theoreticalPlan_toExpdepart.action"
		...
		<div style="width: 1000px;">
			<div id="box0">
				<button class="btn btn-info  ">
					<a
						href="${pageContext.request.contextPath}/theoreticalPlan_B_key_distribution.action?curriculum.college.collegeid=${user.college.collegeid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}&departmenttag=0">一键分配</a>
				</button>
			</div>
		</div>
		<div id="box00">
	...
	<div style="width: 90%; margin-left: 95px;">
		...
		<table class="table table-bordered table-striped table-hover">
				...
				<tr align="center">
							...
							<select class="example-selectAllNumber" multiple="multiple"
								...
								<c:forEach items="${pageBean.theoreticalLessonlist[xh.count-1]}"
									...
									<label> <c:if
											...
											<c:if
												test="${theoreticalLesson.cteachDepartment.departmentCname eq null}">
					...
					<td nowrap="nowrap"><small> <c:forEach
								...
								<c:if
									...
									<%-- (<c:if test="${theoreticalLesson.cteachDepartment.departmentCname ne null}"><span style="color: green;">专业</span></c:if><c:if test="${theoreticalLesson.cteachDepartment.departmentCname eq null and theoreticalLesson.cteacher.username ne null}"><span style="color: green;">教师</span></c:if>)</span> --%>
								</c:if>
					...
					<td nowrap="nowrap"><small> <c:forEach
								...
								<c:if
									test="${theoreticalLesson.cteachDepartment.departmentCname ne null}">
									<a href="javascript:void(0)"
			...
			<form method="post" name="form11"
				action="${pageContext.request.contextPath}/theoreticalPlan_toExpdepart.action?curriculum.college.collegeid=
				...
				<tfoot>
					...
					<tr align="center">
						<th nowrap="nowrap" colspan="11"><c:if
								...
								<a
									href="${pageContext.request.contextPath}/theoreticalPlan_toExpdepart.action?curriculum.college.collegeid=${user.college.collegeid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}&departmenttag=0"><small>首页</small></a>&nbsp;&nbsp;&nbsp;
										<a
									href="${pageContext.request.contextPath}/theoreticalPlan_toExpdepart.action?currentpage=${currentpage-1 }&curriculum.college.collegeid=${user.college.collegeid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}&departmenttag=${newdepartmenttag}"><small>上一页</small></a>
							...
							<c:if test="${pageBean.currentpage != pageBean.totalPage }">
								<a
									href="${pageContext.request.contextPath}/theoreticalPlan_toExpdepart.action?currentpage=${currentpage+1 }&curriculum.college.collegeid=${user.college.collegeid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}&departmenttag=${newdepartmenttag}"><small>下一页</small></a>&nbsp;&nbsp;&nbsp;
										...
										<a
									href="${pageContext.request.contextPath}/theoreticalPlan_toExpdepart.action?currentpage=${pageBean.totalPage }&curriculum.college.collegeid=${user.college.collegeid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}&departmenttag=${newdepartmenttag}"><small>尾页</small></a>
	...
	<script type="text/javascript">
			function selectSubmit() {
				...
				form.action = "${pageContext.request.contextPath}/curriculum_todepart.action";
				form.submit();
			}
		</script>
	<script language="javascript">
		...
		{	
			...
			/* alert(form); */
			form.action = "${pageContext.request.contextPath}/theoreticalPlan_gogiveExpdepart.action?departmenttag&newcurrentpage=${currentpage}";
			form.submit();  
		}
		</script>
