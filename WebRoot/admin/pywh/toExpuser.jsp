...
<body>
	<div class="right_cont">
		...
		<div id="box2">
			<form
				action="${pageContext.request.contextPath}/theoreticalPlan_toExpuser.action?tnum=${user.tnum }"
	...
	<div style="width: 90%; margin-left: 95px;">
		...
		<table class="table table-bordered table-striped table-hover">
			...
			<c:forEach items="${pageBean.curriculumlist }" var="curriculum"
				...
				<tr align="center">
					...
					<td nowrap="nowrap">
						...
						</form> </select> <input type="hidden" name="curriculum.curriculumid"
						value="${curriculum.curriculumid }" />
						</form>
					</td>
			...
			<form method="post" name="form11"
				action="${pageContext.request.contextPath}/theoreticalPlan_toExpuser.action?tnum=${user.tnum }&curriculum.college.collegeid=${user.college.collegeid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}&departmenttag=0">
				<tfoot>
					<tr align="center">
						<th nowrap="nowrap" colspan="11"><c:if
								...
								<a
									href="${pageContext.request.contextPath}/theoreticalPlan_toExpuser.action?tnum=${user.tnum }&curriculum.college.collegeid=${user.college.collegeid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}&departmenttag=0"><small>首页</small></a>&nbsp;&nbsp;&nbsp;
										<a
									href="${pageContext.request.contextPath}/theoreticalPlan_toExpuser.action?tnum=${user.tnum }&currentpage=${currentpage-1 }&curriculum.college.collegeid=${user.college.collegeid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}&departmenttag=${newdepartmenttag}"><small>上一页</small></a>
							...
							<c:if test="${pageBean.currentpage != pageBean.totalPage }">
								<a
									href="${pageContext.request.contextPath}/theoreticalPlan_toExpuser.action?tnum=${user.tnum }&currentpage=${currentpage+1 }&curriculum.college.collegeid=${user.college.collegeid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}&departmenttag=${newdepartmenttag}"><small>下一页</small></a>&nbsp;&nbsp;&nbsp;
										<a
									href="${pageContext.request.contextPath}/theoreticalPlan_toExpuser.action?tnum=${user.tnum }&currentpage=${pageBean.totalPage }&curriculum.college.collegeid=${user.college.collegeid}&curriculum.curriculumid=${theoreticalLesson.curriculum.curriculumid}&curriculum.curriculumCname=${theoreticalLesson.curriculum.curriculumCname}&departmenttag=${newdepartmenttag}"><small>尾页</small></a>
	...
	<script language="javascript">
		...
		{	
			...
			/* alert(form); */
			form.action = "${pageContext.request.contextPath}/theoreticalPlan_gogiveuser.action?cteacher.tnum&cteacher.username&departmenttag&newcurrentpage=${currentpage}";
			form.submit();  
		}
		</script>

	<!-- &curriculum.college.collegeid&curriculum.curriculumid&curriculum.curriculumCname&departmenttag=0&currentpage -->
