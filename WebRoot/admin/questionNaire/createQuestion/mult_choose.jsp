		...
		<div class="content" id="content">
			...
			<ul class="chose_wap" id="chose_wap">
				...
				<li>
					...
					<div class="chose_right_wap">
						<p id="chose_text2" class="chose_text" contenteditable="true"
				...
				<li>
					...
					<div class="chose_right_wap">
						<p id="chose_text3" class="chose_text" contenteditable="true"
							onclick='textnull(3)'>选项C</p>
						<input class="del_chose_btn" type="button" value="删除">
					</div>
				</li>
				...
				<li>
					...
					<div class="chose_right_wap">
						<p id="chose_text4" class="chose_text" contenteditable="true"
							onclick='textnull(4)'>选项D</p>
						<input class="del_chose_btn" type="button" value="删除">
					</div>
				</li>
			</ul>
	...
	<div class="rightwapper">
		<ul>
			<li class="addChose_btn"><input type="button" name=""
				onclick="addChoseMul()" value="增加选项"></li>
			<li class="submitForm_btn">
				<!-- <+> --> <input type="button" name="" value="录入该题"
				onclick="submit_multChose()">
			</li>
		</ul>
	</div>
	</div>
