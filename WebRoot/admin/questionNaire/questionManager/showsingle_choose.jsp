...
">
		<div class="content" id="content">
			...
			<ul class="chose_wap" id="chose_wap">
				<li><c:forEach var="choose_card" items="${clist }">
						<li>
							<div class="chose_left_wap">
								...
								</select>% <input class="radio" name="#" type="radio" value="" />
							</div>
		...
		<input id="addChoice" type="button" name=""
			onclick="addChosesSingle1()" value="增加选项"> <input
			id="hideMinWin" type="button" onclick="hide_Min_Window()" value="关闭">
		<input id="update" type="button"
			onclick="update_single_choose( ${question.tihao} )" value="保存">
	</div>
