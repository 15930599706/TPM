...
<body>
	<div class="right_cont">
		...
		<div id="box9">
			<a
				href="${pageContext.request.contextPath}/practicePlan_toHavePracLesInnerExperimentPage.action?syllabusId=${syllabusId}&practiceLessonid=${newpracticeLesson.practiceLessonid}">返回录入其他内容</a>
		</div>
		<table style="margin-left: 30px; margin-top: 55px;">
		...
		<table style="margin-left: 130px;">
			...
			<tr>
				...
				<td><textarea name="schedule" id="schedule"
						style="width: 450px; height: 100px;">${BaseExperiment.schedule}</textarea></td>
			</tr>
			<tr>
				...
				<td class="input" colspan="3" style="height: 128px;">
					<table border="1px #ooo" id="tab" cellpadding="0" cellspacing="0"
						...
						<c:forEach items="${distributeHour_InnerExperimentlist}"
							var="distributeHour_InnerExperiment">
							...
							<tr class="distributeHour" align="center">
								...
								<td width="30%"><input class="namecourse" type="text"
									style="width: 215px;"
									value="${distributeHour_InnerExperiment.name }" /></td>
								<td width="30%"><input class="classhour" type="number"
									style="width: 50px;"
									value="${distributeHour_InnerExperiment.hoursOfClass }" /></td>
								<td width="30%"><input class="exphour" type="number"
									style="width: 50px;"
									value="${distributeHour_InnerExperiment.hoursOfExp }" /></td>
								<td width="30%"><input class="exp" type="text"
									style="width: 120px;"
									value="${distributeHour_InnerExperiment.exp }" /></td>
								<td width="30%"><input class="disid" type="hidden"
									style="width: 120px;"
									value="${distributeHour_InnerExperiment.distributeHour_InnerExperimentid }" /></td>
							</tr>
						</c:forEach>
					</table>
				</td>
			...
			<table style="margin-left: 130px;">
				...
				<tr>
					<td><textarea name="assess" id="assess"
							style="width: 460px; height: 150px;">${BaseExperiment.assess}</textarea></td>
					</td>
...
<script type="text/javascript">
	...
	function submit() {
		...
		baseExperimentid = document.getElementById("baseExperimentid").value;
 		var url = '${pageContext.request.contextPath}/BaseExperiment_updateBaseExperiment.action?syllabusId=${syllabusId}&practiceLessonid=${newpracticeLesson.practiceLessonid}';
		var s={schedule:schedule,assess:assess,baseExperimentid:baseExperimentid,data: JSON.stringify(result)};
