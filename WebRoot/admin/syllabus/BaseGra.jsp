	...
	<div class="right_cont">
		...
		<table style="margin-left: 130px;">
			<tr>
				...
				<div class="title_right">
					<strong>毕业设计（论文）的选题原则</strong>
				</div>
			</tr>
			<tr>

				<td class="input" colspan="3" style="height: 128px;"><textarea
						name="topic" id="topic" style="height: 150px; width: 530px;">${Basepractice.topic}</textarea></td>
				</td>
		...
		<table style="margin-left: 130px;">
			<tr>
				...
				<div class="title_right">
					<strong>毕业设计（论文）的进度安排</strong>
				</div>
			</tr>
			<tr>
				<input type="hidden" name="basePracticeid" id="basePracticeid"
					value="${Basepractice.basePracticeid}" />
				<td class="item-name">教学安排：</td>
				<td><textarea name="schedule" id="schedule"
						style="width: 460px; height: 150px;">${Basepractice.schedule}</textarea></td>
				</td>
			...
			<tr>
				...
				<td class="input" colspan="3" style="height: 128px;">
					<table border="1px #ooo" id="tab" cellpadding="0" cellspacing="0"
						...
						<c:forEach items="${distributeHour_Gralist}"
							var="distributeHour_Gra">
							<tr class="distributeHour" align="center">
								...
								<td width="30%"><input class="namecourse" type="text"
									style="width: 215px;" value="${distributeHour_Gra.name }" /></td>
								<td width="30%"><input class="time" type="text"
									style="width: 150px;" value="${distributeHour_Gra.time }" /></td>
		...
		<table style="margin-left: 130px;">
			...
			<tr>
				<td><textarea name="assess" id="assess"
						style="width: 530px; height: 150px;">${Basepractice.assess}</textarea></td>
				</td>
...
<script type="text/javascript">
	...
	function submit() {
		...
		basePracticeid = document.getElementById("basePracticeid").value;
		//console.info(result);
		//return;
 		var url = '${pageContext.request.contextPath}/BasePractice_updateBasePractice.action?syllabusId=${syllabusId}&practiceLessonid=${newpracticeLesson.practiceLessonid}';
		var s={topic:topic,schedule:schedule,assess:assess,basePracticeid:basePracticeid,data: JSON.stringify(result)};
