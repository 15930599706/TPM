...
<body>
	...
	<script type="text/javascript">
			function save() {
				...
				console.log(datas);
				var url = "${pageContext.request.contextPath}/abilityAndTeachObj_updateSelectIndexFieldWork.action?syllabusId=${syllabusId}";
				$.post(url, {data: JSON.stringify(datas) }, function(res) {
				window.location.href = "${pageContext.request.contextPath}/abilityAndTeachObj_toAimFieldWorkPage.action?syllabusId=${syllabusId}&practiceLessonid=${newpracticeLesson.practiceLessonid}";
					console.log(res);
				});
			}
