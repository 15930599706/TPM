...
<script language="javascript">
		...
		{			
			...
			if(collegeid != "-1")
			{
				form.action="${pageContext.request.contextPath}/practicePlan_toCheckCourseDesignPageAdmin1.action?tnum=${user.tnum}";
				form.submit(); 
			}
...
<body>
	<div class="right_cont">
		<div class="title_right">
			<strong>实践课大纲下载——<font style="color: #0000c6;">课程设计</font></strong>
		</div>
		<div class="link7">
			<div class="link">
				<a
						...
						<td nowrap="nowrap"><small> <c:if
								...
								<form method="post" id="do${xh.count}" name="do${xh.count}"
									...
									<input type="hidden" name="syllabusId"
										value="${syllabusId[xh.count-1]}" />
									<%--  <input type="hidden" name="theoreticalLessonid" value="${haveSyllabus.theoreticalLessonid}" /> --%>
