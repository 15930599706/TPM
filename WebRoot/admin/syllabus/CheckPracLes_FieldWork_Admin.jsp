...
<script language="javascript">
		...
		{			
			...
			if(collegeid != "-1")
			{
				form.action="${pageContext.request.contextPath}/practicePlan_toCheckPracLesFieldWorkPageAdmin.action?tnum=${user.tnum}";
				form.submit(); 
			}
...
<body>
	<div class="right_cont">
		<div class="title_right">
			<strong>实践课大纲编写情况——<font style="color: #0000c6;">实习</font></strong>
		</div>
		<div class="link">
			<a
				...
				style="color: #0000c6;">查看实习大纲</font></a>
		</div>
		<div class="link1">
			<a
		...
		<div style="padding-left: 24px;">
				...
				<table class="table table-bordered table-striped table-hover">
					...
					<c:forEach items="${haveSyllabusList}" var="haveSyllabus"
						...
						<tr align="center">
							...
							<td nowrap="nowrap"><a
								href="${pageContext.request.contextPath}/ExportWork_exportFieldwork.action?syllabusid=${syllabusId[xh.count-1]}&fieldid=${haveSyllabus.practiceLessonid}"><small>下载</small></a>
							</td>
						</tr>
			...
			<div style="border-bottom: #CCCCCC 1 solid;">
				<h4 style="color: red;">未编写 “实习” 大纲：</h4>
