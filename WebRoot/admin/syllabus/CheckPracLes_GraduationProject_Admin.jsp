...
<script language="javascript">
		...
		{			
			...
			if(collegeid != "-1")
			{
				form.action="${pageContext.request.contextPath}/practicePlan_toCheckGraduationProjectPageAdmin.action?tnum=${user.tnum}";
				form.submit(); 
			}
...
<body>
	<div class="right_cont">
		<div class="title_right">
			<strong>实践课大纲编写情况——<font style="color: #0000c6;">毕业设计</font></strong>
		</div>
		<div class="link">
			<a
		...
		<div class="link1">
			<a
				...
				style="color: #000;">查看课程设计（学年论文）大纲</font></a>
		</div>
		<div class="link2">
			<a
		...
		<div class="link3">
			<a
				...
				style="color: #0000c6;">查看毕业设计大纲</font></a>
		</div>
		<div class="link4">
			<a
		...
		<div style="padding-left: 24px;">
			...
			<div style="border-bottom: #CCCCCC 1 solid;">
				<h4 style="color: red;">未编写 “毕业设计” 大纲：</h4>
