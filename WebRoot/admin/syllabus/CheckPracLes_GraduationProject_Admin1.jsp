...
<script language="javascript">
		...
		{			
			...
			if(collegeid != "-1")
			{
				form.action="${pageContext.request.contextPath}/practicePlan_toCheckGraduationProjectPageAdmin1.action?tnum=${user.tnum}";
				form.submit(); 
			}
...
<body>
	<div class="right_cont">
		<div class="title_right">
			<strong>实践课大纲下载——<font style="color: #0000c6;">毕业设计</font></strong>
		</div>
