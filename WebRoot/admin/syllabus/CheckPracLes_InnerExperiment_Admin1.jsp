...
<script language="javascript">
		...
		{			
			...
			if(collegeid != "-1")
			{
				form.action="${pageContext.request.contextPath}/practicePlan_toCheckInnerExperimentPageAdmin1.action?tnum=${user.tnum}";
				form.submit(); 
			}
...
<body>
	<div class="right_cont">
		<div class="title_right">
			<strong>实践课大纲下载——<font style="color: #0000c6;">实验</font></strong>
		</div>
		<div class="link7">
			<div class="link">
				<a
		...
		<div class="link8">
			...
			<div class="link4">
				<a
					...
					style="color: #0000c6;">实验大纲</font></a>
			</div>
			<div class="link5">
				<a
