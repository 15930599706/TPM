...
<script language="javascript">
		...
		{			
			...
			if(collegeid != "-1")
			{
				form.action="${pageContext.request.contextPath}/theoreticalPlan_toCheckTheoLesAdmin.action?tnum=${user.tnum}";
				form.submit(); 
			}
...
<body>
	<div class="right_cont">
		<div class="title_right">
			<strong>理论课大纲编写情况——<font style="color: #0000c6;">理论课</font></strong>
		</div>
		<div class="link">
			<a
				...
				style="color: #0000c6;">查看理论课大纲</font></a>
		</div>
		<div class="link1">
			<a
				...
				style="color: #000;">查看理论课课内实验大纲</font></a>
		</div>
		...
		<div style="padding-left: 24px;">
			...
			<div style="border-bottom: #CCCCCC 1 solid;">
				<h4 style="color: red;">未编写 “理论课” 大纲：</h4>
