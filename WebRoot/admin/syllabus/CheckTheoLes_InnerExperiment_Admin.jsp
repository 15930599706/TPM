...
<script language="javascript">
		...
		{			
			...
			if(collegeid != "-1")
			{
				form.action="${pageContext.request.contextPath}/theoreticalPlan_toCheckTheoLesInnerExperimentAdmin.action?tnum=${user.tnum}";
				form.submit(); 
			}
...
<body>
	<div class="right_cont">
		<div class="title_right">
			<strong>理论课大纲编写情况——<font style="color: #0000c6;">理论课课内实验</font></strong>
		</div>
		<div class="link">
			<a
				href="${pageContext.request.contextPath}/theoreticalPlan_toCheckTheoLesAdmin.action?tnum=${user.tnum }&curriculum.college.collegeid=<c:if test="${user.adminlevel == 3 || user.adminlevel == 1}">${user.college.collegeid }</c:if><c:if test="${user.adminlevel == 5}">-1</c:if>"><font
				style="color: #000;">查看理论课大纲</font></a>
		</div>
		<div class="link1">
			<a
				href="${pageContext.request.contextPath}/theoreticalPlan_toCheckTheoLesInnerExperimentAdmin.action?tnum=${user.tnum }&curriculum.college.collegeid=<c:if test="${user.adminlevel == 3 || user.adminlevel == 1}">${user.college.collegeid }</c:if><c:if test="${user.adminlevel == 5}">-1</c:if>"><font
				style="color: #0000c6;">查看理论课课内实验大纲</font></a>
		</div>
		...
		<div style="padding-left: 24px;">
			<div style="border-bottom: #CCCCCC 1 solid; padding-top: 5px;">
		...
		<div style="border-bottom: #CCCCCC 1 solid; padding-left: 24px;">
			<h4 style="color: red;">未编写 “理论课课内实验” 大纲：</h4>

		</div>
		<div style="width: 90%; margin-left: 43px;">
			<table class="table table-bordered table-striped table-hover">
