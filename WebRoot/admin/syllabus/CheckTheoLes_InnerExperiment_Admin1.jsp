...
<script language="javascript">
		...
		{			
			...
			if(collegeid != "-1")
			{
				form.action="${pageContext.request.contextPath}/theoreticalPlan_toCheckTheoLesInnerExperimentAdmin1.action?tnum=${user.tnum}";
				form.submit(); 
			}
...
<body>
	<div class="right_cont">
		<div class="title_right">
			<strong>理论课大纲下载——<font style="color: #0000c6;">理论课课内实验</font></strong>
		</div>
		<div class="link7">
			<div class="link">
				<a
			...
			<div class="link1">
				<a
					...
					style="color: #0000c6;">理论课课内实验大纲</font></a>
			</div>
		</div>
		...
		<form method="post" id="search" style=""="10px">
			<div id="box1">
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;学院：</td>
