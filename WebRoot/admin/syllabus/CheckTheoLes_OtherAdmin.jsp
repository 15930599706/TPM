...
<script language="javascript">
		...
		{			
			...
			if(collegeid != "-1")
			{
				form.action="${pageContext.request.contextPath}/practicePlan_toCheckOtherPageAdmin.action?tnum=${user.tnum}";
				form.submit(); 
			}
...
<body>
	<div class="right_cont">
		<div class="title_right">
			<strong>实践课大纲编写情况——<font style="color: #0000c6;">其他</font></strong>
		</div>
		<div class="link">
			<a
		...
		<div class="link4">
			<a
				...
				style="color: #0000c6;">查看其他大纲</font></a>
		</div>
		...
		<div style="padding-left: 24px;">
			...
			<div style="border-bottom: #CCCCCC 1 solid;">
				<h4 style="color: red;">未编写 “其他” 大纲：</h4>
