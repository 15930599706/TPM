...
<body>
	<div class="right_cont">
		...
		<div id="edit_template" style="display: none;">
			<p class="title-new1">编辑实验项目内容单元</p>
			<div
			...
			<p class="title-new1">
				<button
					onclick="onUpdate({{item._id}}, {{item.expermentProjectid}})">更新</button>
...
<script type="text/javascript">
		...
		function onAdd() {
			...
			var url = '${pageContext.request.contextPath}/ExpermentProject_addExpermentProject.action?syllabusId=${syllabusId}';
			console.log(item);
			$.post(url,item,function(data) {
				item.expermentProjectid = data.content;
				list.add(item);
				alert("添加成功");
			});
		}

		function onUpdate(id,expermentProjectid) {
			var options = {};
			...
			options.expermentProjectid = expermentProjectid;
			
			var url = '${pageContext.request.contextPath}/ExpermentProject_updateExpermentProject.action?syllabusId=${syllabusId}';
			console.log(options);
		...
		function onDelete(id,expermentProjectid) {
			var dele = {};
			dele.expermentProjectid = expermentProjectid;
			var url = '${pageContext.request.contextPath}/ExpermentProject_deleteExpermentProject.action';
			console.log(dele);
