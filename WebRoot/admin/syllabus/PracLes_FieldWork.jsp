...
<body>
	<div class="right_cont">
		<div class="title_right">
			<strong>实践课实习大纲录入</strong>
		</div>
		<div id="box9">
			<a
				href="${pageContext.request.contextPath}/practicePlan_toCheckPracLesFieldWorkPage.action?user.tnum=${user.tnum}">返回</a>
		</div>
		<!-------------------------------实习------------------------------------->
				...
				<table class="table table-bordered table-striped table-hover">
					...
					<thead>
						...
						<tr align="center">
							...
							<th width="80" nowrap="nowrap"><small>实习内容</small></th>
						</tr>
					</thead>
					<tr align="center">
						...
						<td nowrap="nowrap">${syllabusId_FieldWorkid}<a
							href="${pageContext.request.contextPath}/FieldWork_toBasePracticePage.action?syllabusId_FieldWorkid=${syllabusId}&practiceLessonid=${newPracticeLesson.practiceLessonid}"><small>编辑</small></a>
						</td>

						<td nowrap="nowrap"><a
							href="${pageContext.request.contextPath}/abilityAndTeachObj_toBefourAimFieldWorkPage.action?syllabusId=${syllabusId}&practiceLessonid=${newPracticeLesson.practiceLessonid}"><small>编辑</small></a>
						</td>
						<td nowrap="nowrap"><a
							href="${pageContext.request.contextPath}/FieldContent_toContentPracticePage.action?syllabusId_FieldWorkid=${syllabusId}&practiceLessonid=${newPracticeLesson.practiceLessonid}"><small>编辑</small></a>
						</td>
