...
<body>
	<div class="right_cont">
		<div class="title_right">
			<strong>实践课毕业设计大纲录入</strong>
		</div>
		<div id="box9">
			<a
				href="${pageContext.request.contextPath}/practicePlan_toCheckPracLesGraduationProjectPage.action?user.tnum=${user.tnum}">返回</a>
		</div>
			...
			<table class="table table-bordered table-striped table-hover">
				...
				<thead>
					<tr align="center">
						...
						<th width="80" nowrap="nowrap"><small>毕设内容</small></th>
				...
				<tr align="center">
					...
					<td nowrap="nowrap"><a
						href="${pageContext.request.contextPath}/BasePractice_toBaseGraPage.action?syllabusId=${syllabusId}&practiceLessonid=${newPracticeLesson.practiceLessonid}"><small>编辑</small></a>
					</td>
					<td nowrap="nowrap"><a
						href="${pageContext.request.contextPath}/abilityAndTeachObj_toBefourAimGraduationProjectPage.action?syllabusId=${syllabusId}&practiceLessonid=${newPracticeLesson.practiceLessonid}"><small>编辑</small></a>
					</td>
					<td nowrap="nowrap"><a
						href="${pageContext.request.contextPath}/ContentGra_toContentGraPage.action?syllabusId=${syllabusId}&practiceLessonid=${newPracticeLesson.practiceLessonid}"><small>编辑</small></a>
					</td>
					<td nowrap="nowrap"><a
						href="${pageContext.request.contextPath}/PracticeBook_toMateriaGraPage.action?syllabusId=${syllabusId}&practiceLessonid=${newPracticeLesson.practiceLessonid}"><small>编辑</small></a>
					</td>
