...
<body>
	<div class="right_cont">
		<div class="title_right">
			<strong>实践课课内实验大纲录入</strong>
		</div>
		<div id="box9">
			<a
				href="${pageContext.request.contextPath}/practicePlan_toCheckPracLesInnerExperimentPage.action?user.tnum=${user.tnum}">返回</a>
		...
		<div style="width: 90%; margin-left: 24px;">
			<table class="table table-bordered table-striped table-hover">
				...
				<tr align="center">
					...
					<td nowrap="nowrap"><a
						href="${pageContext.request.contextPath}/BaseExperiment_toBaseExpPage.action?syllabusId=${syllabusId}&practiceLessonid=${newPracticeLesson.practiceLessonid}"><small>编辑</small></a>
					</td>
					<td nowrap="nowrap"><a
						href="${pageContext.request.contextPath}/abilityAndTeachObj_toBefourAimInnerExperimentPage.action?syllabusId=${syllabusId}&practiceLessonid=${newPracticeLesson.practiceLessonid}"><small>编辑</small></a>
					</td>
					<td nowrap="nowrap"><a
						href="${pageContext.request.contextPath}/ExpermentProject_toContentExpPage.action?syllabusId=${syllabusId}&practiceLessonid=${newPracticeLesson.practiceLessonid}"><small>编辑</small></a>
					</td>
					<td nowrap="nowrap"><a
						href="${pageContext.request.contextPath}/PracticeBookInnerExperiment_toMateriaExpPage.action?syllabusId=${syllabusId}&practiceLessonid=${newPracticeLesson.practiceLessonid}"><small>编辑</small></a>
					</td>
