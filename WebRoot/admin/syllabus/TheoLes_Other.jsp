...
<body>
	<div class="right_cont">
		<div class="title_right">
			<strong>实践其他课大纲录入</strong>
		</div>
		<div id="box9">

			<a
				href="${pageContext.request.contextPath}/practicePlan_toCheckPracticeOther.action?user.tnum=${user.tnum}">返回</a>
		...
		<div style="width: 90%; margin-left: 24px;">
			<table class="table table-bordered table-striped table-hover">
				...
				<tr align="center">
					...
					<td nowrap="nowrap"><a
						href="${pageContext.request.contextPath}/baseTheo_toBaseTheoPage.action?syllabusId=${syllabusId}&theoreticalLessonId=${newTheoreticalLesson.practiceLessonid}&curriculumId=${newTheoreticalLesson.curriculum.curriculumid }"><small>编辑</small></a>
					</td>
					<td nowrap="nowrap"><a
						href="${pageContext.request.contextPath}/abilityAndTeachObj_toBefourAimTheoPage.action?syllabusId=${syllabusId}&theoreticalLessonId=${newTheoreticalLesson.practiceLessonid}&curriculumId=${newTheoreticalLesson.curriculum.curriculumid }"><small>编辑</small></a>
					</td>

					<td nowrap="nowrap"><a
						href="${pageContext.request.contextPath}/ContentTheo_toContentTheoPage.action?syllabusId=${syllabusId}&theoreticalLessonId=${newTheoreticalLesson.practiceLessonid}&curriculumId=${newTheoreticalLesson.curriculum.curriculumid }"><small>编辑</small></a>
					</td>

					<td nowrap="nowrap"><a
						href="${pageContext.request.contextPath}/teaMethodTheo_toTeaMethodTheopage.action?syllabusId=${syllabusId}&theoreticalLessonId=${newTheoreticalLesson.practiceLessonid}&curriculumId=${newTheoreticalLesson.curriculum.curriculumid }"><small>编辑</small></a>
					</td>
					<td nowrap="nowrap"><a
						href="${pageContext.request.contextPath}/TextBooks_toMateriaTheoPage.action?syllabusId=${syllabusId}&theoreticalLessonId=${newTheoreticalLesson.practiceLessonid}&curriculumId=${newTheoreticalLesson.curriculum.curriculumid }"><small>编辑</small></a>
					</td>
