...
<body>
	...
	<div class="right_cont">
		<div class="title_right">
			<strong>添加实验室主任</strong>
		</div>

		<form method="post"
			action="${pageContext.request.contextPath}/user_totjsyszrPage.action?tnum=${user.tnum}&experiment.experimentid=${experiment.experimentid}"
			id="dlzh">
			<div id="box2">
		...
		<div style="width: 70%; margin-left: 24px;">
			<form
				action="${pageContext.request.contextPath}/user_totjsyszrPage.action?tnum=${user.tnum}&username=${newuser.username}&college.collegeid=${newuser.college.collegeid}&experiment.experimentid=${experiment.experimentid}"
				...
				<table class="table table-bordered table-striped table-hover">
					...
					<c:forEach items="${pageBean.userlist }" var="users">
						<tr align="center" class="even">
							...
							<td nowrap="nowrap"><a
								href="${pageContext.request.contextPath}/user_toexperimentadmin.action?modifyid=${user.tnum}&tnum=${users.tnum }&experiment.experimentid=${experiment.experimentid}"
								onclick="if (confirm('您确定要将该教师设置为所选实验室的实验室主任吗？')) return true; else return false;"><small>设置为实验室主任</small></a>
						...
						<tfoot>
							<tr align="center">
								<th nowrap="nowrap" colspan="9"><c:if
										...
										<a
											href="${pageContext.request.contextPath}/user_totjsyszrPage.action?tnum=${user.tnum}&username=${newuser.username}&college.collegeid=${newuser.college.collegeid}&experiment.experimentid=${experiment.experimentid}"><small>首页</small></a>&nbsp;&nbsp;&nbsp;
									<a
											href="${pageContext.request.contextPath}/user_totjsyszrPage.action?tnum=${user.tnum}&username=${newuser.username}&college.collegeid=${newuser.college.collegeid}&experiment.experimentid=${experiment.experimentid}&currentpage=${currentpage-1 }"><small>上一页</small></a>
									</c:if>&nbsp;&nbsp;&nbsp; <small>共${pageBean.totalCount }条记录,共计${pageBean.totalPage }页,当前第${pageBean.currentpage }页</small>&nbsp;&nbsp;&nbsp;
									<c:if test="${pageBean.currentpage != pageBean.totalPage }">
										<a
											href="${pageContext.request.contextPath}/user_totjsyszrPage.action?tnum=${user.tnum}&username=${newuser.username}&college.collegeid=${newuser.college.collegeid}&experiment.experimentid=${experiment.experimentid}&currentpage=${currentpage+1 }"><small>下一页</small></a>&nbsp;&nbsp;&nbsp;
									<a
											href="${pageContext.request.contextPath}/user_totjsyszrPage.action?tnum=${user.tnum}&username=${newuser.username}&college.collegeid=${newuser.college.collegeid}&experiment.experimentid=${experiment.experimentid}&currentpage=${pageBean.totalPage }"><small>尾页</small></a>
